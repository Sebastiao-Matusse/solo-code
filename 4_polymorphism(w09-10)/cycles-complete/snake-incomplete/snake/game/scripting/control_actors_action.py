...
class ControlActorsAction(Action):
    ...
    def __init__(self, keyboard_service):
        ...
        self._direction_one = Point(0, -1 * constants.CELL_SIZE)
        self._direction_two = Point(0, -1 * constants.CELL_SIZE)
    ...
    def execute(self, cast, script):
        ...
        snake.turn_head(self._direction_one)

        # The player two movements
        # left
        ...
        player_two.turn_head(self._direction_two)